...
@pytest.mark.asyncio
@patch("app.domains.quest.service.is_llm_working", return_value=True)
@patch("app.domains.quest.service.LLMService")
...
@pytest.mark.asyncio
@patch("app.domains.quest.service.FIRESTORE_AVAILABLE", True)
@patch("app.domains.quest.service.firestore", create=True)
