...
def get_agent_service() -> AgentService:
    ...
    """
    return AgentService(history_summary_cache=history_summary_cache)

def get_pipeline_services() -> PipelineServices:
    """
...
def get_openalex_headers(openalex_service: OpenAlexService = Depends(get_openalex_service)) -> dict:
    """
