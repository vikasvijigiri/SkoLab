...
fun BrandMark(
    ...
    primaryColor: Color = com.company.skolab.ui.theme.AccentViolet,
    accentColor: Color = com.company.skolab.ui.theme.AccentCyan
) {
...
fun BrandTagline(
    modifier: Modifier = Modifier,
    color: Color = com.company.skolab.ui.theme.SkoLabTextSecondary
) {
    val context = LocalContext.current
    Text(
