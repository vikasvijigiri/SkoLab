    ...
    <div className="relative flex min-h-dvh flex-col overflow-x-clip bg-page-bg">
      <header className="relative z-10 flex shrink-0 items-center gap-3 px-6 py-6 md:px-10">
        <Link
          ...
          className="group flex h-8 w-8 items-center justify-center rounded-full border border-border bg-surface text-text-secondary transition-[color,border-color,background-color,box-shadow] duration-[var(--motion-fast)] hover:border-primary/40 hover:bg-surface-subtle hover:text-primary hover:shadow-card"
