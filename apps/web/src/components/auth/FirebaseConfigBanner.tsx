...
export function FirebaseConfigBanner() {
  return (
    <div className="mb-5 flex items-start gap-3 rounded-md border border-accent-amber/40 bg-accent-amber/10 px-3.5 py-3">
      <TriangleAlert size={16} className="mt-1 shrink-0 text-accent-amber" />
