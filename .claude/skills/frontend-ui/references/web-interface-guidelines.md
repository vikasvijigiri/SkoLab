...
description: Line-level rule set to audit web UI against — interactivity, focus, forms, animation, typography, performance, i18n, content. Verbatim from vercel-labs/web-interface-guidelines. Read in frontend-ui Phase 1; audited in Phase 3.
---

# Web Interface Guidelines — complete checklist

**Source:** `github.com/vercel-labs/web-interface-guidelines` — `command.md`,
pulled 2026-09-08. Reproduced verbatim. This is the rule set the upstream
`web-design-guidelines` skill audits against; kept here as a static reference
because the upstream repo cannot be vendored in this environment (the
deploy-spend-guard hook blocks any command containing a cloud-vendor name).
`DESIGN.md` remains the local authority on tokens, type, spacing, and motion.
