...
fun BrandMark(
    ...
    primaryColor: Color = com.open.skolab.ui.theme.AccentViolet,
    accentColor: Color = com.open.skolab.ui.theme.AccentCyan
) {
...
fun BrandTagline(
    modifier: Modifier = Modifier,
    color: Color = com.open.skolab.ui.theme.SkoLabTextSecondary
) {
    val context = LocalContext.current
    Text(
