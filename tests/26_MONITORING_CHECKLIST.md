...
- [x] Server node metrics (CPU utilization, memory usage, network egress) collected.
  * **Status:** PASS
  * **Evidence:** [main.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/backend/app/main.py) lines 753-780, and [test_monitoring.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/backend/tests/test_monitoring.py) lines 13-22.
...
- [x] Disk space metrics alarm SRE when capacity crosses 80% boundaries.
  * **Status:** PASS
  * **Evidence:** [main.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/backend/app/main.py) lines 259-281 (lifespan background task `monitor_disk_space`), and lines 776-785 (exporting `host_disk_used_percent` metric).
...
- [x] Log shipper pipelines forward json logs to Elasticsearch/Loki endpoints.
  * **Status:** PASS
  * **Evidence:** [docker-compose.yml](file:///c:/Users/VikasVijigiri/Documents/QyRus/infra/docker-compose.yml) lines 23-42, and [promtail-config.yml](file:///c:/Users/VikasVijigiri/Documents/QyRus/infra/promtail-config.yml).
...
- [x] Error occurrences (>10 in 5 min) alert active engineering channels.
  * **Status:** PASS
  * **Evidence:** [alertmanager-alerts.yml](file:///c:/Users/VikasVijigiri/Documents/QyRus/infra/alertmanager-alerts.yml) lines 9-17, and [log_alert_notifier.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/scripts/log_alert_notifier.py).
...
- [x] Synthetic health checks request backend paths every 60 seconds.
  * **Status:** PASS
  * **Evidence:** [synthetic_health_probe.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/scripts/synthetic_health_probe.py).
...
- [x] Failed synthetic requests page the on-call responder.
  * **Status:** PASS
  * **Evidence:** [synthetic_health_probe.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/scripts/synthetic_health_probe.py) lines 39-44.
...
- [x] Outbound connections to OpenAlex and Groq endpoints monitored for latency/status.
  * **Status:** PASS
  * **Evidence:** [telemetry.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/backend/app/core/telemetry.py) lines 62-118, [main.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/backend/app/main.py) lines 514-539, and [test_monitoring.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/backend/tests/test_monitoring.py) lines 39-63.
...
- [x] External status metrics display on SRE dashboard panels.
  * **Status:** PASS
  * **Evidence:** [main.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/backend/app/main.py) lines 785-802 (exporting `outbound_http_requests_total` and `outbound_http_request_duration_seconds` metrics).
...
- [x] System status pages display real-time availability states to users.
  * **Status:** PASS
  * **Evidence:** [system.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/backend/app/api/v1/endpoints/system.py) lines 24-81 (get_system_status), and [test_monitoring.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/backend/tests/test_monitoring.py) lines 24-37.
...
- [x] Incidents resolve statuses are dynamically updated upon fix deployment.
  * **Status:** PASS
  * **Evidence:** [incidents.json](file:///c:/Users/VikasVijigiri/Documents/QyRus/docs/incidents.json), and [system.py](file:///c:/Users/VikasVijigiri/Documents/QyRus/backend/app/api/v1/endpoints/system.py) lines 53-61.
...
- [x] Metric thresholds tuned periodically to prevent false positive alarms.
  * **Status:** PASS
  * **Evidence:** [alertmanager-alerts.yml](file:///c:/Users/VikasVijigiri/Documents/QyRus/infra/alertmanager-alerts.yml), and [prometheus.yml](file:///c:/Users/VikasVijigiri/Documents/QyRus/infra/prometheus.yml) line 4.
